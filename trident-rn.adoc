...
NetApp continua a migliorare e migliorare i propri prodotti e servizi. Di seguito sono riportate alcune delle funzionalità e delle funzionalità più recenti disponibili in Astra Trident.

Per le release precedenti, vedere https://docs.netapp.com/us-en/trident/earlier-versions.html["Ealier versioni della documentazione"].



=== Cambiamenti da Astra Trident 21.10.0
...
=== Cambiamenti da Astra Trident 21.07
